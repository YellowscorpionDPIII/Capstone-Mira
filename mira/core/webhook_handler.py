...
class WebhookHandler:
    ...
    Includes OpenAPI spec at /docs endpoint.
    """
    ...
    def _setup_routes(self):
        """Set up Flask routes for webhooks with OpenAPI documentation."""
        ...
        def openapi_docs():
            ...
            return render_template_string(SWAGGER_UI_HTML, spec=OPENAPI_SPEC)
